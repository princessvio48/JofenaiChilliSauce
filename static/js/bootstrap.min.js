                            ...
                            (e.prototype.toggle = function() {
                                ...
                                n &&
                                    this._element.setAttribute(
                                        "aria-pressed", !t(this._element).hasClass(r.ACTIVE)
                                    ),
                        ...
                        return (
                            ...
                            (l.prototype._slide = function(e, n) {
                                ...
                                if (
                                    ...
                                    this._isSliding = !1;
                                else if (!this._triggerSlideEvent(a, g).isDefaultPrevented() &&
                                    o &&
                                    a
                                ) {
                                    (this._isSliding = !0),
                                    ...
                                    if (
                                        (this._parent &&
                                            ((n = t.makeArray(
                                                ...
                                                (n = null)), !(n && (i = t(n).data(s)) && i._isTransitioning))
                                    ) {
                        ...
                        return (
                            ...
                            (l._clearMenus = function(e) {
                                if (!e ||
                                    ...
                                    for (
                                        var n = t.makeArray(t(d.DATA_TOGGLE)), i = 0; i < n.length; i++
                                    ) {
